...
const Quick = () => {
	...
	return (
		<div className="min-h-screen bg-[#05070A] text-gray-100 flex flex-col justify-center selection:bg-purple-500 selection:text-white relative overflow-hidden py-12">
			{/* 背景科技感发光光晕 */}
			<div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-[#2C76E5]/15 via-[#955AFF]/15 to-[#6FD9EC]/10 blur-[140px] rounded-full pointer-events-none" />

			{showLists && (
				<div className="py-6 relative z-10 transition-all duration-300">
					<div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
						<div className="flex">
							...
							>
								<div className="p-2.5 rounded-2xl bg-gray-900/80 border border-gray-800/80 group-hover:border-[#6FD9EC]/50 shadow-lg transition-all">
									<ArrowLongLeftIcon width={24} className="text-[#6FD9EC]" />
								</div>
								<span className="pl-3 font-semibold tracking-wide text-base">Back to {type}</span>
							</div>
						</div>
						<div className="py-6">
							<div className="backdrop-blur-2xl bg-gray-900/60 border border-gray-800/80 p-6 sm:p-8 rounded-3xl shadow-[0_15px_40px_rgba(0,0,0,0.6)]">
								<ListsTable
									lists={selectedLists}
			...
			<div className={`flex flex-col justify-center sm:py-6 sm:px-6 lg:px-8 relative z-10 ${showLists ? 'hidden' : ''}`}>
				<Link
					href="/airdrop"
					className="flex w-full text-center md:hidden pt-2 pb-4 px-4 group"
				>
				...
				<div className="mt-4 mx-4 sm:mx-auto sm:w-full sm:max-w-md">
					{/* 极酷毛玻璃卡片 */}
					<div className="backdrop-blur-2xl bg-gray-900/75 py-8 px-6 shadow-[0_25px_60px_rgba(0,0,0,0.8)] border border-gray-800/90 rounded-3xl sm:px-10 relative overflow-hidden">
						{/* 卡片顶部的霓虹流光边线 */}
						<div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#955AFF] to-transparent opacity-90" />
						...
						<div className="space-y-6">
							<div className="flex flex-row items-center justify-between">
								...
								<div className="bg-gray-950/80 p-1.5 rounded-2xl border border-gray-800/80 shadow-inner">
									<Switcher
										leftLabel="Buy"
										rightLabel="Sell"
										selected={type}
							...
							<div className={`${loading ? 'animate-pulse opacity-75' : ''} transition-opacity`}>
